...
//
// NOTICE REGARDING: C:\Projects\QuantumSafe\Shared\Common\Interfaces\Persistance\IDbQueryResult.cs  
...
{
	public interface IPersistenceQueryResult<T> : IPersistenceResult
	{
		List<T> QueryResult { get; set; }
	}
}